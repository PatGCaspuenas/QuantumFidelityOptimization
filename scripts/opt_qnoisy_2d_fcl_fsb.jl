...
function main()
    ...
    savefig(p, "figures/opt_qnoisy_hetero_2d_fcl_fsb.png")
    println("Saved -> figures/opt_qnoisy_hetero_2d_fcl_fsb.png")

    anim, fps = animate2d_hetero(resH; f_true=Q_true, nx=25, ny=25, fps=6, show_noise=true, learn_hypers=false)
    gif(anim, "figures/opt_qnoisy_hetero_2d_fcl_fsb.gif", fps=fps)
    println("Saved -> figures/opt_qnoisy_hetero_2d_fcl_fsb.gif")
end
